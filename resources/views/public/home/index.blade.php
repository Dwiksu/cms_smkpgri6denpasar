<x-app>
    ...
    <section id="hero"
        ...
        <div class="relative z-10 px-4 py-10 max-w-screen-xl text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#tentang-kami"
                    class="px-7 py-3 rounded-full bg-amber-300 text-white font-medium hover:bg-transparent hover:text-amber-300 border border-amber-300 transition">
                    Lihat Selengkapnya
                </a>
                <a href="#jurusan"
                    class="px-7 py-3 rounded-full border border-white text-white hover:bg-white hover:text-gray-900 transition">
                    Lihat Jurusan
                </a>
            </div>
        </div>
    ...
    <section id="tentang-kami" class="py-20 bg-white">
        <div class="max-w-screen-xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
            <div class="relative">
    ...
    {{-- ================= STATS ================= --}} <section id="stats" class="bg-image py-14">
                                ...
                                <a href="{{ route('public.jurusan.show', $major->slug) }}" class="swiper-slide mb-1">
                                    <article class="bg-white rounded-lg shadow c-hover group">
                                        <div class="w-full h-48 rounded-t-lg overflow-hidden">
                                            <img src="{{ asset($major->image) }}" alt="{{ $major->name }}"
                                                loading="lazy"
